...
ol li {width:46%; float:left; font-size:23px; padding-left:8px; line-height:50px; position:relative; left:40px;top:10px; color:#303030; margin-left:30px; font-weight:600;
&:before {position:absolute; content:'';width:30px !important; height:30px !important; 
font-size:14px !important; left: -34px;top: 9px;
